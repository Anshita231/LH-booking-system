  ...
  const login = async (data) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        // Reload page to trigger authentication validation
        window.location.href = role === "gsec" ? "/book" : 
          (role === "assistantRegistrar" || role === "systemAdministrator" || role === "facultyMentor") ? "/requests" : "/";
